                ...
                <hr>
                    <div class="jumbotron" style="margin-top: 20px;">
						...
						<div class="content">
							...
							<p>- Маркет модификаций и модулей, где разработчики могут размещать собственные разработки, а администраторы игровых серверов могут осуществлять покупку.</p>
							<p>- Фриланс площадка, где администраторы могут создавать задания на выполнение, а разработчики могут брать их и выполнять.</p>
							<br>
							<p>Мы удерживаем небольшой процент за проведение операций, а вся остальная сумма отправляется разработчиками по указанным в профиле реквизитам.</p>
							<div class="separator"></div>
