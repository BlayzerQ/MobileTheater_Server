                    ...
                    <div class="jumbotron" style="margin-top: 20px;">
						...
						<sec:authorize access="!isAuthenticated()">
							<div class="row justify-content-center mt-4 product-buy-buttons">
								<button type="button" class="col-auto btn btn-primary mx-1" data-toggle="modal" data-target="#exampleModal">Войдите, чтобы купить</button>
							</div>
						</sec:authorize>
						<sec:authorize access="isAuthenticated()">
							<div class="row justify-content-center mt-4 product-buy-buttons">
								<a href="/payment/${product.id}" class="col-auto btn btn-primary mx-1" target="_self"><i class="fa fa-download" aria-hidden="true"></i> Купить за ${product.price} ₽</a> 
							</div>
						</sec:authorize>
