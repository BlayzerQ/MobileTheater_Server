						...
						<nav class="navbar filters shadow-sm">
							<form class="row" id="filters-panel" autocomplete="off" action="/tasks" method="get">
								<div class="input-group col-5">
									<input type="text" id="search" name="search" value="" class="form-control" placeholder="Поиск по названию мода">
								...
								<div class="col-auto filters-checkboxes checkbox-correction">
									<div class="custom-control custom-checkbox custom-control-inline">
										<input type="checkbox" name="fp_cost_options[]" value="free" class="custom-control-input" id="fp_cost_options_0">
										<label class="custom-control-label" for="fp_cost_options_0">Бесплатные</label>
									</div>
									<div class="custom-control custom-checkbox custom-control-inline">
										<input type="checkbox" name="fp_cost_options[]" value="paid" class="custom-control-input" id="fp_cost_options_1">
							...
							<li class="content-list__item">
								<article class="user user_short">
									<figure class="user__avatar user__avatar_r50">
										<a href="/account/${item.creator}"><img class="avatario" src="https://freelansim.ru/assets/default/users/avatar_r50-a6ce93fe35b158fd29ba0e8681c918c22117160e9586a56eee4ffbc20df9bda1.png"></a>
										<span class="user-profile__status_verified user-profile__status_verified_mini" title="Верифицирован">
									...
									<div class="user__info">
										...
										<div class="user__tags">
											<ul class="tags tags_short">
												<li class="tags__item"><a class="tags__item_link" href="/tasks?q=minecraft">minecraft</a></li>
